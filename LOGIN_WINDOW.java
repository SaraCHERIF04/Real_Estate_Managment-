...
public class LOGIN_WINDOW extends javax.swing.JFrame {
    ...
    public LOGIN_WINDOW() {
        initComponents();
        /* don't forget to dawnload mysql connector and add it to the project and open xampp and start apache and mysql*/
        //create data base using phpmyadmin
        
        
         // center the form 
         this.setLocationRelativeTo(null);
        //dispaly im    ge in the jlabel1
        jLabel_Image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/building.jpg")));
        jLabel_Username_icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/account-6491185_640.png")));
        jLabel_Password_icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/padlock-303266_640.png")));
    ...
    private void initComponents() {
        ...
        jLabel_Password_icon.setBackground(new java.awt.Color(255, 255, 255));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jLabel_Username_icon, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel_Password_icon, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jTextField_Username, javax.swing.GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(88, 88, 88)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jTextField_Username, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
    ...
    private void jTextField_UsernameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField_UsernameFocusGained
        ...
        //remove the text from the failed on focus gained
    ...
    private void jPasswordField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jPasswordField1FocusLost
      //if the password field is empty -> set it to 'password'
       String password = String.valueOf(jPasswordField1.getPassword());
        if( password .trim().toLowerCase().equals("tiger")|| password .trim().equals(""))
        {
           jPasswordField1.setText("tiger");
    ...
    private void jPasswordField1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jPasswordField1FocusGained
       //clear the password field on focus if text =password 
    //get the password 
    String password = String.valueOf(jPasswordField1.getPassword());
    if(password.trim().toLowerCase().equals("tiger")) {
    ...
    // Check THE fileds value
    if (username.trim().toLowerCase().equals("username")|| 
            password.trim().toLowerCase().equals("tiger")) 
    {
        JOptionPane.showMessageDialog(null, "Enter Your Username and Password First","Empty Filed ",2);
    } else {
